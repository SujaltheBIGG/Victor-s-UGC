      ...
      <form onSubmit={handleArchitectAgent} className="space-y-8 w-full">
        ...
        <div className="flex flex-col gap-4">
          <button
            ...
            className="w-full py-3 bg-lime-500 dark:bg-primary hover:bg-lime-600 dark:hover:bg-primary/90 disabled:bg-gray-200 dark:disabled:bg-divider disabled:text-gray-400 dark:disabled:text-secondary-text disabled:cursor-not-allowed text-black text-base font-semibold rounded-xl transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
          >
            {loading ? (
              <>
