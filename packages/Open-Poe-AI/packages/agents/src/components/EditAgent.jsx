    ...
    return (
      <main className="flex-1 flex items-center justify-center">
        <div className="flex flex-col items-center gap-2">
          <BiLoaderAlt className="w-12 h-12 text-lime-600 animate-spin" />
      ...
      <div className="flex items-center justify-between pb-2 border-b border-gray-50 dark:border-divider w-full">
        ...
        <div className="flex items-center gap-3">
          <Link 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-lime-600 hover:bg-lime-700 rounded-xl text-sm font-bold text-black transition-all active:scale-95 shadow-sm"
          >
          ...
          <Link 
            href="/docs/agents"
            target="_blank"
            className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 dark:bg-secondary-bg border border-gray-100 dark:border-divider rounded-lg text-xs font-bold text-lime-600 dark:text-primary hover:bg-lime-50 dark:hover:bg-primary-bg transition-all active:scale-95 shadow-sm"
          >
            Docs
          </Link>
        </div>
            ...
            <div className="flex items-center gap-8 w-full">
              <div className="relative">
                <div 
                  ...
                  className="w-28 h-28 rounded-full bg-gray-100 dark:bg-secondary-bg overflow-hidden ring-4 ring-white dark:ring-primary-bg shadow-sm border border-gray-100 dark:border-divider cursor-pointer group transition-all hover:ring-lime-500/30"
                >
                  {formData.icon_url ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-50 dark:bg-primary-bg transition-colors group-hover:bg-gray-100 dark:group-hover:bg-secondary-bg">
                      <RiRobot2Fill className="w-12 h-12 text-gray-300 dark:text-divider group-hover:text-lime-500 transition-colors" />
                    </div>
                  )}
                ...
                <div 
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-xl cursor-pointer transition-all duration-300 ${
                    formData.is_published 
                      ? "bg-white dark:bg-primary-bg shadow-sm text-lime-600 dark:text-primary" 
                      : "text-gray-400 hover:text-gray-600 dark:text-secondary-text dark:hover:text-primary-text"
                  }`}
                >
                  <div className={`w-2 h-2 rounded-full transition-all duration-500 ${formData.is_published ? "bg-lime-500 shadow-[0_0_8px_rgba(163,230,53,0.5)]" : "bg-gray-300 dark:bg-gray-600"}`} />
            ...
            <div className="p-8">
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  className="w-full h-40 p-5 bg-gray-50 dark:bg-primary-bg border border-gray-200 dark:border-divider rounded-2xl text-sm focus:ring-2 focus:ring-lime-500/20 focus:border-lime-500 outline-none transition-all resize-none dark:text-white placeholder:text-gray-400"
                />
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    ...
                    className="flex-[2] px-6 py-4 bg-lime-600 hover:bg-lime-700 disabled:opacity-50 text-black font-bold rounded-2xl transition-all shadow-lg shadow-lime-500/20 active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    {generatingIcon ? (
                      <>
            ...
            <div className="p-8 grid grid-cols-1 gap-4">
              <div
                ...
                className={`group flex flex-col items-center gap-4 p-8 rounded-[2rem] border transition-all duration-300 active:scale-[0.98] cursor-pointer ${
                  isDragging
                    ? "border-2 border-dashed border-lime-500 bg-lime-50 dark:bg-lime-500/10"
                    : "bg-gray-50 dark:bg-primary-bg border-gray-100 dark:border-divider hover:border-lime-500/50 hover:bg-white dark:hover:bg-secondary-bg hover:shadow-xl hover:shadow-lime-500/5"
                }`}
              >
                <div className="w-16 h-16 rounded-2xl bg-white dark:bg-secondary-bg shadow-sm flex items-center justify-center text-gray-400 group-hover:text-lime-500 transition-colors duration-300">
              ...
              <button
                ...
                className="group flex flex-col items-center gap-4 p-8 bg-lime-50/30 dark:bg-lime-500/5 rounded-[2rem] border border-lime-100/50 dark:border-lime-500/20 hover:border-lime-500 hover:bg-white dark:hover:bg-secondary-bg transition-all duration-300 hover:shadow-xl hover:shadow-lime-500/10 active:scale-[0.98]"
              >
                <div className="w-16 h-16 rounded-2xl bg-lime-600 shadow-lg shadow-lime-500/30 flex items-center justify-center text-black transform transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
                  <IoSparklesOutline className="w-8 h-8" />
                </div>
                <div className="text-center">
                  <h4 className="font-bold text-lime-600 dark:text-primary text-lg">Generate with AI</h4>
                  <p className="text-sm text-lime-500/70 dark:text-primary/70 mt-1">Create unique icon from prompt</p>
                </div>
              </button>
            </div>
          </div>
