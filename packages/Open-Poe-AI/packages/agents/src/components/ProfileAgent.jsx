          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {agent.is_published && (
                  <span className="flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full bg-lime-50 dark:bg-white/10 text-lime-600 dark:text-gray-300 border border-lime-100 dark:border-white/10">
