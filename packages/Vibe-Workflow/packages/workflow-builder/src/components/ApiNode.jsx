    ...
    >
        ...
        {data.isLoading ? (
          <div className="flex items-center justify-center w-full h-full overflow-hidden aspect-[1/1] bg-white/5 animate-pulse rounded-b-2xl">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-[10px] font-bold text-lime-500 tracking-wider uppercase">Processing...</span>
            </div>
          </div>
        ) : data.errorMsg ? (
      ...
      {(() => {
        ...
        if (output?.type === 'text' || modelType === 'chat') {
          outputColor = "blue";
          activeClass = "!bg-lime-600 !border-zinc-900 shadow-[0_0_15px_rgba(132,204,22,0.8)]";
          inactiveClass = "!bg-zinc-900 !border-lime-600/50 hover:!border-lime-600 shadow-sm";
          labelText = "Text";
