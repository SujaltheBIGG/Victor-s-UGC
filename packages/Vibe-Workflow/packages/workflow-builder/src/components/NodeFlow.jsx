...
const NodeFlow = ({
  ...
  const connectionLineStyle = {
    stroke: activeHandleColor === 'blue' ? '#a3e635'
    ...
    <div tabIndex={0} onKeyDown={onKeyDown} className="flex h-dvh w-full relative">
            ...
            {interactionMode ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-1.5 border border-gray-600/70 bg-lime-500 text-black text-sm rounded-full font-semibold group cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:bg-black hover:text-white whitespace-nowrap"
                >
                  {isRunning === 1 ? (
                    <>
      ...
      <div className={`absolute left-4 self-center z-20 flex flex-col gap-2 bg-[#151618] p-1 rounded-full border border-gray-700 shadow-xl ${isRestoring && "hidden"}`}>
        ...
        <button
          ...
          className="p-3 rounded-full hover:bg-[#1b1e23] cursor-pointer outline-none text-gray-300 active:bg-lime-600 hover:text-white transition"
        >
                  ...
                  {dropDown === 3 && (
                    <div className={`absolute left-0 ${isModelDropdownUp ? "bottom-full mb-2" : "top-16"} bg-zinc-900/95 backdrop-blur-3xl z-20 border border-white/10 p-1 rounded-xl flex flex-col gap-2 shadow-2xl max-h-64 w-full animate-in fade-in zoom-in duration-200`}>
                      <input
                        ...
                        className="px-3 py-2 text-xs bg-black/40 border border-white/5 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:border-lime-500/50 transition-all"
                      />
                    ...
                    return selectedNode?.data?.loading === 1 ? (
                      ...
                      <div className="flex flex-col gap-2 w-full h-full relative pt-2">
                        <button
                          ...
                          className="absolute top-0 z-10 text-[10px] font-bold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 group disabled:cursor-not-allowed rounded-full text-black bg-lime-600 px-3 py-1 border border-lime-500/50 hover:bg-lime-500 transition-all self-end shadow-lg shadow-lime-900/20"
                        >
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className="w-9 h-5 bg-gray-700 rounded-full peer peer-checked:bg-lime-600 transition-colors"></div>
              ...
              {!selectedNode?.data?.selectedModel?.id?.includes("passthrough") && (
                <button
                  ...
                  className="text-sm font-semibold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 group disabled:cursor-not-allowed rounded-lg text-black bg-lime-500 px-4 py-2 border border-lime-500/50 hover:bg-lime-600 w-full transition-all shadow-lg shadow-lime-900/20 active:scale-[0.98]"
                >
        ...
        <div className="bg-[#242629] rounded-lg p-4 w-72 shadow-lg flex flex-col gap-4" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex items-center w-full gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-white text-black rounded-full hover:bg-lime-500 hover:text-white transition w-full text-sm cursor-pointer"
            >
              Save
            </button>
          </div>
              ...
              {presets.map((preset) => (
                ...
                >
                  <div className="z-10 p-2 bg-[#242629] border-b border-gray-700 flex items-center px-3 justify-between">
                    <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 rounded-full ${preset.id === "empty-workflow" ? "bg-gray-400" : "bg-lime-500"}`}></div>
                  ...
                  <div className="z-0 p-4 flex flex-col gap-3 h-full">
                    <div className="flex items-center justify-center gap-2 z-10 w-full h-full">
                      <div className="text-white group-hover:text-lime-400 transition-colors">
                        {iconMap[preset.icon] || <RiInputMethodLine size={16} />}
                      </div>
                      <h3 className="text-sm font-medium text-white leading-tight group-hover:text-lime-400 transition-colors">
                        {preset.title}
                      </h3>
                    </div>
                    {preset.image && (
          ...
          <div className="bg-[#1b1e23] border border-gray-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
              ...
              <div className="space-y-4">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#151618] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-lime-500/50 hover:border-gray-600 transition-all"
                    autoFocus
                  />
                </div>
              </div>
            ...
            <div className="p-4 bg-[#151618]/50 flex items-center justify-end gap-3 border-t border-gray-700/50">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium bg-lime-600 hover:bg-lime-500 text-black rounded-xl transition-all shadow-lg shadow-lime-900/20 active:scale-95"
              >
                <MdSave size={18} />
                Save Category
              </button>
