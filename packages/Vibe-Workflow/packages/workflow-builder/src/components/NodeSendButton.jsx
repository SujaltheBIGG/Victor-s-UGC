  ...
  return (
    <div className="relative">
      <button
        ...
        className={`group/btn relative flex items-center justify-center w-5 h-5 rounded-full transition-all duration-300 bg-lime-600 hover:bg-lime-500 text-black shadow-lg`}
