...
const PromptConcate = ({ id, data, selected }) => {  
  ...
  return (
    ...
    >
          ...
          <Handle  
            ...
            className={`!rounded-full !border-2 transition-all duration-200 !left-[-7px]
              ${connectedInputs.concatInput 
                ? '!bg-lime-500 !border-white shadow-[0_0_20px_rgba(163,230,53,1)]' 
                : '!bg-black !border-lime-500 shadow-[0_0_20px_rgba(163,230,53,0.5)]'
              }
              hover:!scale-125 hover:shadow-[0_0_20px_rgba(163,230,53,1)]
            `}
            data-type="blue"
          />
          <p 
            className={`absolute -left-7 top-[100px] text-xs text-lime-500 transition-opacity duration-200 ${
      ...
      />
      <p 
        className={`absolute -right-7 top-[100px] text-xs text-lime-500 transition-opacity duration-200 ${
          data.activeHandleColor === "blue" 
            ? "opacity-100" 
            : "opacity-0 group-hover:opacity-100"
        }`}
