  ...
  return (
    <section className="flex w-[170px] shrink-0 snap-center flex-col md:w-[190px]">
      <div className="mb-3 flex items-center justify-between px-1">
        ...
        <span className="h-1.5 w-1.5 rounded-full bg-gradient-to-b from-[#b0fb5d] to-[#a855f7] shadow-[0_0_6px_rgba(176,251,93,0.5)]" />
      </div>

      <div className="relative h-[320px] overflow-hidden rounded-2xl border border-white/[0.06] bg-[#030303] shadow-inner">
        <div className="pointer-events-none absolute inset-x-2 top-1/2 z-0 h-[82px] -translate-y-1/2 rounded-xl border border-[#b0fb5d]/20 bg-gradient-to-r from-[#b0fb5d]/15 to-purple-500/10 shadow-[0_0_15px_rgba(176,251,93,0.1)]" />
              ...
              >
                <span
                  className={`flex shrink-0 items-center justify-center font-semibold transition-colors ${
                    imageUrl
                      ? "h-10 w-10"
                      : "text-base text-white/55 group-data-[selected=true]:text-[#b0fb5d]"
                  }`}
                >
                  {imageUrl ? (
                    <img
    ...
    >
      ...
      >
        <div className="flex items-start justify-between border-b border-white/[0.05] px-5 py-5 md:px-7 md:py-6">
          <div>
            <div className="mb-2 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#b0fb5d]">
              <svg
                width="15"
                height="15"
                viewBox="0 0 24 24"
        ...
        {history.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                ...
                className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-xl hover:border-[#b0fb5d]/50 transition-all duration-300 flex flex-col cursor-pointer"
              ...
              >
                ...
                <div className="absolute top-2 right-2 hidden md:flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/60 font-black backdrop-blur-md transition-all hover:bg-[#b0fb5d] hover:text-black ${
                      copiedPromptIndex === idx ? "text-[#b0fb5d]" : "text-white"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/60 backdrop-blur-md transition-all hover:bg-[#b0fb5d] hover:text-black ${
                      copiedImageIndex === idx ? "text-[#b0fb5d]" : "text-white"
                    }`}
                  >
                ...
                <div className="p-3 bg-black/80 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col justify-between gap-2">
                  ...
                  <div className="flex items-center mt-1 flex-wrap gap-1">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-[#b0fb5d] px-2 py-0.5 bg-[#b0fb5d]/10 rounded border border-[#b0fb5d]/20">
                        {copy.card.badge}
                      </span>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-4 animate-fade-in-up transition-all duration-700 min-h-[50vh]">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4 text-center px-4 flex flex-col items-center">
              ...
              <span className="text-[#b0fb5d] font-black uppercase text-2xl sm:text-4xl sm:mt-1 tracking-tight">
                {copy.empty.title}
              </span>
            </h1>
      ...
      >
          ...
          <div className="flex items-start gap-4 w-full px-1">
            ...
            >
              ...
              <button
                ...
                }) + (isImageDragging ? " ring-2 ring-[#b0fb5d] ring-offset-1 ring-offset-black scale-105" : "")}
              >
                {isUploadingImage ? (
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-white/40 group-hover:text-[#b0fb5d] transition-colors">
          ...
          <PromptFooter>
            <PromptControls>
              ...
              >
                <div className="w-1.5 h-1.5 bg-[#b0fb5d] rounded-full shadow-lg shadow-[#b0fb5d]/20 shrink-0" />
                <span className="max-w-[120px] truncate text-xs font-semibold text-white/70 group-hover:text-[#b0fb5d] transition-colors">
