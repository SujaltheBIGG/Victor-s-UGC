...
function UploadButton({ apiKey, maxImages, onSelect, onClear, initialUrls = [], label = null, persistedHistory = null, onHistoryChange = null, copy }) {
  ...
  const triggerContent = uploading ? (
    ...
    <svg
      ...
      stroke="currentColor"
      strokeWidth="2.5"
      className="text-white/40 group-hover:text-[#b0fb5d] transition-colors"
    >
                    ...
                    <div
                      className={`w-8 h-8 ${
                        family.id.includes("kontext")
                          ? "bg-lime-500/10 text-lime-400 border-lime-500/10"
      ...
      <PromptComposer>
          ...
          <PromptFooter>
            ...
            <PromptControls ref={dropdownRef}>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="opacity-40 text-white group-hover:text-[#b0fb5d] transition-colors">
                  <path d="M12 20h9" />
