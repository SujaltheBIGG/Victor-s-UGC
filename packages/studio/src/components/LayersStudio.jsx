            ...
            >
              ...
              {activeTool === "lasso" && lassoPoints.length > 1 && (
                ...
                >
                  <path
                    ...
                    fill="rgba(176, 251, 93, 0.18)"
                    stroke="#b0fb5d"
                    strokeWidth="4"
                    strokeDasharray="8 8"
                    className="drop-shadow-[0_0_15px_rgba(176,251,93,0.8)]"
                  />
                </svg>
              )}
              ...
              {activeTool === "regional-edit" &&
                ...
                regionalBox.height > 0 && (
                  <div
                    className="absolute border-2 border-dashed border-[#b0fb5d] bg-[#b0fb5d]/10 rounded-lg pointer-events-auto shadow-[0_0_25px_rgba(176,251,93,0.5)] z-30"
                    style={{
                      left: `${regionalBox.x}%`,
                      top: `${regionalBox.y}%`,
                  ...
                  >
                    <div className="absolute -top-1.5 -left-1.5 w-3 h-3 bg-[#b0fb5d] border border-white rounded-full" />
                    <div className="absolute -top-1.5 -right-1.5 w-3 h-3 bg-[#b0fb5d] border border-white rounded-full" />
                    <div className="absolute -bottom-1.5 -left-1.5 w-3 h-3 bg-[#b0fb5d] border border-white rounded-full" />
                    <div className="absolute -bottom-1.5 -right-1.5 w-3 h-3 bg-[#b0fb5d] border border-white rounded-full" />
                  </div>
                )}
