    ...
    <button
      ...
      className={promptMediaButtonClassName({
        ...
        className: isDragging
          ? "ring-2 ring-[#b0fb5d] ring-offset-1 ring-offset-black scale-105"
          : "",
      })}
    >
      <input
            ...
            <div className="flex items-center gap-2">
              ...
              {inputMode === "video" && (
                <MediaPickerButton
                  ...
                  mediaCopy={copy.media}
                  icon={
                    <VideoIcon className="text-white/40 group-hover:text-[#b0fb5d] transition-colors" />
                  }
              ...
              <MediaPickerButton
                ...
                mediaCopy={copy.media}
                icon={
                  <MicIcon className="text-white/40 group-hover:text-[#b0fb5d] transition-colors" />
                }
