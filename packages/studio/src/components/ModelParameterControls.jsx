...
const FIELD_CLASS =
  "w-full rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-xs text-white outline-none transition-colors focus:border-[#b0fb5d]/50";
    ...
    <div className="flex flex-col gap-2">
      ...
      {items.length < maxItems && (
        <button
          ...
          className="rounded-lg border border-dashed border-white/10 px-3 py-2 text-xs font-semibold text-white/45 hover:border-[#b0fb5d]/30 hover:text-[#b0fb5d]"
        >
          + Add
        </button>
      )}
