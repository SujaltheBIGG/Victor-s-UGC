    ...
    <button
      ...
      className={promptMediaButtonClassName({
        ...
        className: isDragging
          ? "border-[#b0fb5d] bg-[#b0fb5d]/10 ring-2 ring-[#b0fb5d]/50 scale-105"
          : "",
      })}
    >
      <input
        ...
        {["videos", "images", "results"].map((tab) => (
          <button
            ...
            className={`flex-1 text-center py-1 text-xs font-bold capitalize transition-colors ${
              activeTab === tab
                ? "text-[#b0fb5d] border-b border-[#b0fb5d]"
          ...
          items.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  type="button"
                  className="text-xs text-black font-black px-2.5 py-1 bg-[#b0fb5d] rounded-md hover:bg-[#b0fb5d]/90 transition-colors"
                >
                  {copy.buttons.use}
                </button>
                <button
          ...
          <div className="flex items-center gap-2 px-1">
            <div className="flex items-center gap-2">
              ...
              <MediaPickerButton
                ...
                icon={<VideoIcon className="text-white/40 group-hover:text-[#b0fb5d] transition-colors" />}
              ...
              <MediaPickerButton
                ...
                icon={<ImageIcon className="text-white/40 group-hover:text-[#b0fb5d] transition-colors" />}
          ...
          <PromptFooter>
            <PromptControls>
              ...
              <div className="relative">
                ...
                >
                  <div className="w-3.5 h-3.5 bg-[#b0fb5d] rounded-sm flex items-center justify-center">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-white/70 group-hover:text-[#b0fb5d] transition-colors">
                    {copy.labels.library}
                  </span>
                  <PromptChevronIcon />
                </button>
