...
const DEFAULT_ACTION_CLASS =
  "bg-[#b0fb5d] text-black px-7 py-3 rounded-full font-bold text-sm hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#b0fb5d]/20 hover:shadow-[#b0fb5d]/35 border border-[#b0fb5d]/10 z-10 disabled:opacity-50 disabled:cursor-not-allowed";

const CONTROL_LAYOUT_CLASS =
  "h-[38px] flex items-center gap-2 rounded-md transition-all border group whitespace-nowrap shadow-inner focus:outline-none focus-visible:border-[#b0fb5d]/45 focus-visible:ring-1 focus-visible:ring-[#b0fb5d]/30";

const CONTROL_IDLE_CLASS =
  "text-white bg-[#16161a]/60 hover:bg-[#202026]/80 border-white/[0.06]";

const CONTROL_ACTIVE_CLASS =
  "text-[#b0fb5d] bg-[#b0fb5d]/10 hover:bg-[#b0fb5d]/15 border-[#b0fb5d]/25";

const MEDIA_CONTROL_LAYOUT_CLASS =
  "w-10 h-10 shrink-0 rounded-full border transition-all flex items-center justify-center relative overflow-hidden group focus:outline-none focus-visible:border-[#b0fb5d]/45 focus-visible:ring-1 focus-visible:ring-[#b0fb5d]/30";
...
export function promptMediaButtonClassName({
  ...
  return joinClasses(
    ...
    active
      ? "border-[#b0fb5d]/60 bg-[#b0fb5d]/5 hover:border-[#b0fb5d]/70"
      : "border-white/[0.03] bg-white/[0.03] hover:bg-white/[0.06] hover:border-[#b0fb5d]/40",
    className,
  );
}
...
export const PROMPT_CONTROL_LABEL_CLASS =
  "text-xs font-semibold text-current opacity-70 group-hover:text-[#b0fb5d] group-hover:opacity-100 transition-all";
  ...
  return (
    <button
      ...
      className={joinClasses(
        ...
        "text-xs font-semibold text-white/70 hover:bg-[#b0fb5d]/10 hover:text-[#b0fb5d] focus:outline-none focus-visible:bg-[#b0fb5d]/10 focus-visible:text-[#b0fb5d]",
        className,
      )}
    >
  ...
  return (
    <button
      ...
      className={joinClasses(
        ...
        "focus:outline-none focus-visible:ring-1 focus-visible:ring-[#b0fb5d]/40",
        selected
          ? "bg-[#b0fb5d] text-black shadow-md shadow-[#b0fb5d]/20"
